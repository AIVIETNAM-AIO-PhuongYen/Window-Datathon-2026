...
- Mô hình dự báo: Hệ thống Ensemble (kết hợp LightGBM 80%, Ridge Regression 10% và Prophet 10%) đạt độ chính xác cao với $R^2 \approx 0.83$ (LightGBM).
...
4. Datathon2026_Đội_thi_Window.pdf:
